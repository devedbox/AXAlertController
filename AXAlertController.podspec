Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/devedbox/AXAlertController"
  ...
  s.source       = { :git => "https://github.com/devedbox/AXAlertController.git", :tag => s.version }


  s.source_files  = "AXAlertController/AXAlertController/*.{h,m}"
