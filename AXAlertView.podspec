#
#  Be sure to run `pod spec lint AXAlertView.podspec' to ensure this is a
...
# s.license      = "MIT (example)"
  ...
  s.source       = { :git => "https://github.com/devedbox/AXAlertView.git", :tag => s.version }
  ...
  s.source_files  = "AXAlertView/AXAlertView/*.{h,m}"
